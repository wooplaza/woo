...
require_once($base_path . '/includes/search.class.php');

require_once($base_path . '/includes/aq_resizer.class.php');

require_once($base_path . '/includes/jackbox.class.php');

require_once($base_path . '/includes/social-gallery.class.php');
...
if(is_admin()){ // && ( ! defined( 'DOING_AJAX' ) || ! DOING_AJAX ) 
	...
	require_once($base_path . '/admin/includes/newsletter.class.php');
