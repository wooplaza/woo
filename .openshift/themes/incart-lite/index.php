		 ...
		 <div class="container">
			 <div class="row-fluid">
				  <div class="container_inner clearfix">
					 <h1 class="title"><?php if(sketch_get_option($incart_lite_shortname.'_blogpage_heading')) { echo sketch_get_option($incart_lite_shortname.'_blogpage_heading'); } ?></h1>
				   </div>
			 </div>
		</div>
	</div>
		 ...
		 <div class="row-fluid">
			  <div id="container" class="span8">
				<div id="content">
					...
					<?php if(is_sticky($post->ID)) { _e("<div class='sticky-post'>featured</div>",'incart-lite'); } ?>
