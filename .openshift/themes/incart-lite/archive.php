			...
			<div class="row-fluid">
				<div class="container_inner clearfix">
					<h1 class="title">
						<?php
						if ( is_day() ) :
							printf( __( 'Daily Archives : <span>%s</span>', 'incart-lite' ), get_the_date() );
						elseif ( is_month() ) :
							printf( __( 'Monthly Archives : <span>%s</span>', 'incart-lite' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'incart-lite' ) ) );
						elseif ( is_year() ) :
							printf( __( 'Yearly Archives : <span>%s</span>', 'incart-lite' ), get_the_date( _x( 'Y', 'yearly archives date format', 'incart-lite' ) ) );
						else :
							_e( 'Blog Archives', 'incart-lite' );
						endif;
						?>
					</h1>
					<?php  
