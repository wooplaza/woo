...
?>
				...
				<div class="entry-content">
					<div class="entry-attachment">
						<div class="attachment">
							<?php jehanne_the_attached_image(); ?>
						</div><!-- .attachment -->
		...
		<nav id="image-navigation" class="navigation image-navigation">
			<div class="nav-links">
			<?php previous_image_link( false, '<div class="previous-image">&larr; ' . __( 'Previous Image', 'jehanne' ) . '</div>' ); ?>
			<?php next_image_link( false, '<div class="next-image">' . __( 'Next Image &rarr;', 'jehanne' ) . '</div>' ); ?>
			</div><!-- .nav-links -->
