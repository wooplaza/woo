...
return array(
    ...
    array(
        ...
        'desc' => __('Want to use the search on header?', 'yit' ),
        'options' => array(
            'none'  => __( 'None', 'yit' ),
    ...
    array(
        ...
        'desc' => __('Want to use the "Shop by Category" menu on header? (It is valid only for Skin 1 of header)', 'yit' ),
        'std' => 'yes',
        'in_skin'        => true,
        'deps'  => array(
    ...
    array(
        ...
        'desc' => __('Want to use keep "Shop by Category" opened on sliders in header? (It is valid only for Skin 1 of header)', 'yit' ),
        'std' => 'yes',
        'deps' => array(
            'ids'       => 'header-show-search',
            'values'    => 'big'
