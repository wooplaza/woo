...
<div class="shop-by-category border-line-2 nav vertical<?php if ( $opened ) echo ' opened' ?>">

	<a href="#" class="list-trigger"><?php _e( 'Shop by category', 'yit' ) ?><span class="sbToggle"></span></a>
