...
function yit_woocommerce_hooks() {
    ...
    if ( yit_get_option( 'shop-buy-now-button' ) == 'yes' ) add_filter ( 'add_to_cart_redirect', 'yit_redirect_to_checkout');
...
if ( ! function_exists( 'yit_button_wishlist' ) ) {
    ...
    function yit_button_wishlist( $html, $url, $product_type, $exists ) {
        ...
        $html  = '<div class="yith-wcwl-add-to-wishlist border">';
