...
class YIT_Widget_Recent_Reviews extends WP_Widget {
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'product' ) ); ?>"><?php _e( 'Select Product', 'yit' ); ?></label>
            <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'product' ) ) ?>" name="<?php echo esc_attr( $this->get_field_name( 'product' ) ) ?>">
